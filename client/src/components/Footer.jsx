...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r bg-black text-white border-t border-gray-800">
      {/* Big Footer */}
      <div className="container max-w-7xl mx-auto py-10 px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Column 1 */}
          <div>
            <h3 className="text-2xl font-bold mb-4">Blog<span className="text-yellow-300">Agency</span></h3>
            <p className="text-sm">
      ...
      <div className="bg-gray-700 py-4 text-center text-sm">
        <p>
          &copy; {new Date().getFullYear()} BlogAgency. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
